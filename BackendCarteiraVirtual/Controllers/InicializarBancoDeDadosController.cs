    ...
    public class InicializarBancoDeDadosController : ControllerBase
    {
        ...
        public RetornoPost Get()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                sqlQuery += " BEGIN ";
                sqlQuery += "   CREATE TABLE TRANSACOES(COD_TRANSACAO INTEGER IDENTITY(1,1), COD_USUARIO_PAGADOR INTEGER, COD_USUARIO_RECEBEDOR INTEGER, VALOR NUMERIC(15,2), DATA DATETIME) ";
